...
export const companyFacts = sqliteTable("company_facts", {
  id: integer("id").primaryKey({ autoIncrement: true }), workspaceId: text("workspace_id").notNull(), factType: text("fact_type").notNull(), subject: text("subject").notNull(), valueJson: text("value_json").notNull(), source: text("source").notNull(), evidenceJson: text("evidence_json").notNull().default("[]"), confidence: integer("confidence").notNull().default(60), status: text("status").notNull().default("active"), validFrom: text("valid_from"), validUntil: text("valid_until"), lastVerifiedAt: text("last_verified_at").notNull(), ...timestamps,
});
export const knowledgePacks = sqliteTable("knowledge_packs", { id: integer("id").primaryKey({ autoIncrement: true }), scope: text("scope").notNull().default("atlas"), workspaceId: text("workspace_id"), packKey: text("pack_key").notNull(), name: text("name").notNull(), description: text("description").notNull(), industry: text("industry"), stage: text("stage"), channel: text("channel"), status: text("status").notNull().default("active"), version: integer("version").notNull().default(1), ...timestamps });
export const knowledgeEntries = sqliteTable("knowledge_entries", { id: integer("id").primaryKey({ autoIncrement: true }), packId: integer("pack_id").notNull(), entryType: text("entry_type").notNull(), title: text("title").notNull(), content: text("content").notNull(), tagsJson: text("tags_json").notNull().default("[]"), source: text("source").notNull(), confidence: integer("confidence").notNull().default(70), status: text("status").notNull().default("active"), ...timestamps });
export const decisionJournal = sqliteTable("decision_journal", { id: integer("id").primaryKey({ autoIncrement: true }), workspaceId: text("workspace_id").notNull(), cycleId: integer("cycle_id"), goalId: integer("goal_id"), opportunityId: integer("opportunity_id"), decisionType: text("decision_type").notNull(), title: text("title").notNull(), rationale: text("rationale").notNull(), alternativesJson: text("alternatives_json").notNull().default("[]"), evidenceJson: text("evidence_json").notNull().default("[]"), contextJson: text("context_json").notNull().default("{}"), score: integer("score").notNull(), confidence: integer("confidence").notNull(), status: text("status").notNull().default("proposed"), ...timestamps });
export const growthExperiments = sqliteTable("growth_experiments", { id: integer("id").primaryKey({ autoIncrement: true }), workspaceId: text("workspace_id").notNull(), planId: integer("plan_id"), decisionId: integer("decision_id"), goalId: integer("goal_id"), name: text("name").notNull(), hypothesis: text("hypothesis").notNull(), strategyKey: text("strategy_key").notNull(), channel: text("channel"), primaryMetric: text("primary_metric").notNull(), baselineValue: real("baseline_value"), targetValue: real("target_value"), attributionModel: text("attribution_model").notNull().default("workspace_delta"), minimumDelta: real("minimum_delta").notNull().default(1), successThresholdPct: real("success_threshold_pct").notNull().default(5), evaluationStartsAt: text("evaluation_starts_at"), evaluationEndsAt: text("evaluation_ends_at"), baselineCapturedAt: text("baseline_captured_at"), completedAt: text("completed_at"), status: text("status").notNull().default("planned"), ...timestamps });
export const experimentResults = sqliteTable("experiment_results", { id: integer("id").primaryKey({ autoIncrement: true }), workspaceId: text("workspace_id").notNull(), experimentId: integer("experiment_id").notNull(), metricValue: real("metric_value"), outcome: text("outcome").notNull(), confidence: integer("confidence").notNull().default(50), summary: text("summary").notNull(), evidenceJson: text("evidence_json").notNull().default("[]"), measuredAt: text("measured_at").notNull(), createdAt: text("created_at").notNull().default(sql`CURRENT_TIMESTAMP`) });
export const strategyLessons = sqliteTable("strategy_lessons", { id: integer("id").primaryKey({ autoIncrement: true }), workspaceId: text("workspace_id").notNull(), strategyKey: text("strategy_key").notNull(), lessonType: text("lesson_type").notNull(), statement: text("statement").notNull(), evidenceJson: text("evidence_json").notNull().default("[]"), confidence: integer("confidence").notNull().default(50), status: text("status").notNull().default("active"), lastAppliedAt: text("last_applied_at"), ...timestamps });
export const strategyPerformance = sqliteTable("strategy_performance", { id: integer("id").primaryKey({ autoIncrement: true }), workspaceId: text("workspace_id").notNull(), strategyKey: text("strategy_key").notNull(), experimentsCount: integer("experiments_count").notNull().default(0), successCount: integer("success_count").notNull().default(0), failureCount: integer("failure_count").notNull().default(0), consecutiveFailures: integer("consecutive_failures").notNull().default(0), weight: real("weight").notNull().default(1), suppressedUntil: text("suppressed_until"), lastOutcome: text("last_outcome"), lastEvaluatedAt: text("last_evaluated_at"), ...timestamps });
